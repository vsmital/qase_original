//--------------------------------------------------
// Name:			MatLabGeneralObserverBot.java
 ...
 *	MatLabGeneralObserverBot, since it provides better performance. For
 *	an example of MatLabGeneralBots in action, see the accompanying MatLab
 *	script. See also the QASE User Guide, Sections 5.5 and 6.2.*/
/*-------------------------------------------------------------------*/
public final class MatLabGeneralObserverBot extends MatLabObserverBot
{
/*-------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------*/
	public MatLabGeneralObserverBot(String botName, String botSkin)
	{
		super((botName == null ? "MatLabGeneralObserverBot" : botName), botSkin, 0);
	}
...
/*-------------------------------------------------------------------*/
	public MatLabGeneralObserverBot(String botName, String botSkin, boolean trackInv)
	{
		super((botName == null ? "MatLabGeneralObserverBot" : botName), botSkin, 0, trackInv);
	}
 ...
 *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
	public MatLabGeneralObserverBot(String botName, String botSkin, boolean highThreadSafety, boolean trackInv)
	{
		super((botName == null ? "MatLabGeneralObserverBot" : botName), botSkin, highThreadSafety, 0, trackInv);
	}
 ...
 *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
	public MatLabGeneralObserverBot(String botName, String botSkin, String password, boolean highThreadSafety, boolean trackInv)
	{
		super((botName == null ? "MatLabGeneralObserverBot" : botName), botSkin, password, highThreadSafety, 0, trackInv);
	}
 ...
 *	@param trackInv if true, the agent will manually track its inventory */
/*-------------------------------------------------------------------*/
	public MatLabGeneralObserverBot(String botName, String botSkin, int recvRate, int msgLevel, int fov, int hand, String password, boolean highThreadSafety, boolean trackInv)
	{
		super((botName == null ? "MatLabGeneralObserverBot" : botName), botSkin, recvRate, msgLevel, fov, hand, password, highThreadSafety, 0, trackInv);
	}
