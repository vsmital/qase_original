 ...
 *	provided by the MatLabGeneralBot family. For an example of MatLabPollingBot
 *	in action, see SampleMatLabPollingBot and the accompanying MatLab script.
